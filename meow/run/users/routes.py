...
from run.models import User, Post
from run.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm)
from run.users.utils import save_picture
...
def account():
	...
	if form.validate_on_submit():
		...
		db.session.commit()
		flash('account updated lol', 'primary')
